...
urlpatterns = [
    ...
    path('schedule_edit_list/<int:id>',views.edit_schedule_list),
    path('schedule_edit/<int:doctorid>/<int:scheduleid>',views.get_editschedule),
    path('schedule_update/<int:doctorid>/<int:scheduleid>',views.update_schedule),
